    ...
    return(
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-10 px-2">
                <div className="flex flex-1 justify-start flex-col mf:mr-40">
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
                        Send money <br/>across the world<br/>Using Blockchain 
                    </h1>
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        Explore the Blockchain world. <br/>
                         Send and recieve crypto currencies using <b>VittPay.</b>
                    </p>
                    {!currentAccount && (
                        <button 
                        type="button"
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        <div className={commonStyles}>Reliabile</div>
                        <div className={commonStyles}>Secure</div>
                        <div className={commonStyles}>Superrrr Fast</div>
                        <div className={commonStyles}>Made in India</div>
                        <div className={commonStyles}>No hidden cost</div>
                        <div className={commonStyles}>Easy to use</div>
                    </div>
                </div>
